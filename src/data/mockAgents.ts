...
export const mockAgents: Agent[] = [
  {
    ...
    rating: 4.8,
    usageCount: 1523,
    tags: ['Database', 'API', 'Real-time', 'Enterprise'],
    isActive: true,
  ...
  },
  {
    ...
    rating: 4.7,
    usageCount: 1092,
    tags: ['Security', 'Encryption', 'Compliance', 'Monitoring'],
    isActive: true,
  ...
  },
  {
    ...
    rating: 4.6,
    usageCount: 987,
    tags: ['Analytics', 'Reports', 'Visualization', 'Business Intelligence'],
    isActive: true,
  ...
  },
  {
    ...
    rating: 4.8,
    usageCount: 2156,
    tags: ['Content', 'AI', 'Marketing', 'Writing'],
    isActive: true,
